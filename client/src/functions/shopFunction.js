...
export const getShopItems = async (token) => {
  try {
    const url = "http://localhost:3001/api/shop/getitems";
...
export const createShopItem = async (token, data) => {
  try {
    const url = "http://localhost:3001/api/shop/post";
...
export const deleteShopItem = async (token, id) => {
  try {
    const url = `http://localhost:3001/api/shop/${id}`;
...
export const soldShopItem = async (token, data, id) => {
  try {
    const url = `http://localhost:3001/api/shop/sold/${id}`;
    const response = await axios.put(url, data, {
      headers: { Authorization: `Bearer ${token}` },
    });
    return response.data;
